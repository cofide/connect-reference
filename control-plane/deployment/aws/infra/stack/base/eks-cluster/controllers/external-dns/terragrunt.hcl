...
locals {
  default_config = {
    role_name   = "cofide-connect-control-plane-aws-reference-arch-external-dns"
    policy_name = "cofide-connect-control-plane-aws-reference-arch-external-dns"
...
terraform {
  source = "${get_repo_root()}//control-plane/deployment/aws/infra/modules/external-dns"
}
