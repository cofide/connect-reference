...
terraform {
  source = "${get_repo_root()}//control-plane/deployment/aws/infra/modules/connect/database"
}
...
inputs = {
  ...
  connect_db_name   = local.merged_config.connect_db_name
  connect_db_user   = local.merged_config.connect_db_user
}
