...
2. Uninstall the Connect API and UI Helm charts: `helm uninstall -n connect connect connect-ui`. ExternalDNS controller will delete the corresponding Route53 DNS records and AWS Loadbalancer Controller will delete the corresponding network loadbalancers.
